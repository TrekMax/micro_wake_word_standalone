...
namespace esphome
{
    ...
    { // NOLINT
      ...
      public:
        ...
        {
            return has_value() ? &optional::this_type_does_not_support_comparisons : nullptr;
        }
        ...
        template <class U> value_type value_or(U const &v) const
        {
    ...
    template <typename T> inline bool operator==(optional<T> const &x, nullopt_t)
    {
        return (!x);
    }

    template <typename T> inline bool operator==(nullopt_t, optional<T> const &x)
    {
        return (!x);
    }
    ...
    template <typename T> inline bool operator<(optional<T> const &, nullopt_t)
    {
        return false;
    }
    ...
    template <typename T> inline bool operator<=(nullopt_t, optional<T> const &)
    {
        return true;
    }
    ...
    template <typename T> inline optional<T> make_optional(T const &v)
    {
        return optional<T>(v);
    }
