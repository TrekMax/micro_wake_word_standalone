...
#define LOG_UPDATE_INTERVAL(this)                                                                                      \
    ...
    class Component
    {
      ...
      protected:
         ...
         * @param f The function (or lambda) that should be called
         * @param backoff_increase_factor time between retries is multiplied by this factor on every retry after the
         * first
         * @see cancel_retry()
         */
        ...
        void set_retry(uint32_t initial_wait_time, uint8_t max_attempts,
                       std::function<RetryResult(uint8_t)> &&f, // NOLINT
