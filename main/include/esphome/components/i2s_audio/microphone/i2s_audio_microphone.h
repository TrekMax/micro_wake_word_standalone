    ...
    namespace i2s_audio
    {
        ...
        class I2SAudioMicrophone : public I2SAudioComponent, public microphone::Microphone
        {
          public:
            ...
            void set_din_pin(gpio_num_t pin)
            {
                this->din_pin_ = pin;
            }
            ...
            void set_channel(i2s_chan_config_t config)
            {
                this->channel_config_ = config;
            }
            void set_sample_rate(uint32_t sample_rate)
            {
                this->sample_rate_ = sample_rate;
            }
            void set_bits_per_sample(i2s_data_bit_width_t bits_per_sample)
            {
