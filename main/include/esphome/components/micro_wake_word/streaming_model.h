    ...
    namespace micro_wake_word
    {
        ...
        class StreamingModel
        {
          public:
            ...
            /// @brief Allocates tensor and variable arenas and sets up the model
            /// interpreter
            /// @param op_resolver MicroMutableOpResolver object that must exist until the
            /// model is unloaded
            /// @return True if successful, false otherwise
            bool load_model(tflite::MicroMutableOpResolver<20> &op_resolver);

            /// @brief Destroys the TFLite interpreter and frees the tensor and variable
            /// arenas' memory
            void unload_model();
        ...
        {
          public:
            VADModel(const uint8_t *model_start, float probability_cutoff, size_t sliding_window_size,
